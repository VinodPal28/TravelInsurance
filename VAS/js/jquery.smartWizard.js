...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('').text(this.options.lang.next).addClass(' ').attr('type', '') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('').text(this.options.lang.previous).addClass('btn btn-secondary sw-btn-prev').attr('type', '') : null;
            var btnGroup = $('').addClass('').attr('role', 'group').append(btnPrevious, btnNext);

            // Add extra toolbar buttons
            var btnGroupExtra = null;

            if (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0) {
                btnGroupExtra = $('').addClass('').attr('role', 'group');
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                case 'top':
                    toolbarTop = $('').addClass('' + this.options.toolbarSettings.toolbarButtonPosition);
                    ...
                    break;
                case 'bottom':
                    toolbarBottom = $('').addClass('' + this.options.toolbarSettings.toolbarButtonPosition);

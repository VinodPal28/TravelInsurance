...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                ...
                                <div class="table-responsive" id="Gridview-container">
                                    ...
                                    <asp:GridView ID="GV_WalletApproval" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" ShowHeaderWhenEmpty="true" class="table table-de mb-0" AutoGenerateColumns="false" PageSize="10" AllowPaging="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Available Balance" ItemStyle-Width="25%" HeaderStyle-Width="25%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <label id="TotalBalance" class="btn btn-success">
                                                        <i class="fa fa-rupee" aria-hidden="true"></i>
                                                        <asp:Label ID="HiddenField1" runat="server" Text='<%#Bind("TotalBalance") %>'></asp:Label>
                                                    </label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="View" ItemStyle-Width="10%" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnview" runat="server" class="btn btn-sm round btn-outline-danger" Text="Views" CommandName="View" CommandArgument="<%# Container.DataItemIndex + 1 %>" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <div class="modal dark_bg login-form-btn" id="Model_Approve" tabindex="-2" role="dialog" aria-labelledby="exampleModalLabel8" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div style="height:20px"> <center><asp:Label ID="lblmsgApprove" runat="server" ></asp:Label> </center></div>
    ...
    <div class="modal dark_bg login-form-btn" id="Model_Details" tabindex="-2" role="dialog" aria-labelledby="exampleModalLabel8" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModa2">Wallet Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="Refresh();"><span aria-hidden="true">×</span> </button>
                </div>
                <div class="modal-body">
                    <div class="card">
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    <h5>Partner Code</h5>
                                                    <div class="controls">
                                                        <asp:TextBox ID="lblPartnerCode" runat="server" class="form-control" placeholder="Partner Code" ReadOnly="true"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <asp:TextBox ID="lblPartnername" runat="server" class="form-control" placeholder="Partner Name" ReadOnly="true"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    <label for="projectinput2">Payment details<span class="starRed">*</span></label>
                                                    <div class="controls">
                                                        <asp:TextBox ID="lblPayment_details" runat="server" class="form-control" placeholder="Payment details" ReadOnly="true"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    <label for="projectinput2">Amount(INR)*<span class="starRed"></span></label>
                                                    <div class="controls">
                                                        <asp:TextBox ID="lblAmountInr" runat="server" class="form-control" placeholder="Amount(INR)" ReadOnly="true"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <asp:TextBox ID="lblPaymentMethod" runat="server" class="form-control" placeholder="Payment Method" ReadOnly="true"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    <label for="projectinput2">Comments (if any)<span class="starRed"></span></label>
                                                    <div class="controls">
                                                        <asp:TextBox ID="lblComments" runat="server" class="form-control" placeholder="Comments (if any)" ReadOnly="true"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                           ...
                                           <%-- <div class="col-md-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label for="projectinput2">Upload Image*<span class="starRed"></span></label>
                                                        <div class="controls">                                                          
                                                              <asp:HiddenField ID="hdnUploadImg" runat="server" Value='<%#Eval("File") %>'></asp:HiddenField>
                                                              <asp:Button ID="lnkView" runat="server" class="btn btn-sm round btn-outline-danger" CommandName="ViewImg" Text="View Image" />

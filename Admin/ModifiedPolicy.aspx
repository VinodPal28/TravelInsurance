<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ModifiedPolicy.aspx.cs" Inherits="Admin_ModifiedPolicy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script>
        function ViewMsg() {
            setTimeout(function () {
                $("#Model_ModifiedPolicies").modal('show');
            }, 100);
        }
    </script>
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <h1 class="h1Tag">Endorsed Policies</h1>
                <br />
                <!-- Active Orders -->
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-content">
                                <div class="table-responsive">
                                    <table class="table table-de mb-0">
                                        <asp:GridView ID="GV_ModifiedPolicy" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" ShowHeaderWhenEmpty="true" class="table table-de mb-0" AutoGenerateColumns="false" PageSize="10" AllowPaging="true"
                                            PagerStyle-CssClass="bs-pagination" Width="100%" OnPageIndexChanging="GV_ModifiedPolicy_PageIndexChanging" OnRowCommand="GV_ModifiedPolicy_RowCommand">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Endorsement Number">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCanNo" runat="server" Text='<%#Bind("PolicyModificationNo") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
    ...
    <div class="modal dark_bg login-form-btn" id="Model_ModifiedPolicies" tabindex="-2" role="dialog" aria-labelledby="exampleModalLabel8" aria-hidden="true">

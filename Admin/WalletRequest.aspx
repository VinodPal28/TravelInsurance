...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        // $('#txtPayMethoDetails').AlphaNumeric();
        $(document).ready(function () {
            ...
            $('#btnSave').click(function () {
                ...
                if (paymentMethod == "cheque") {
                    // alert(2);
                    if (PayDetails == '') {
                        $("#MsgFileupload").text("Enter the details").css("color", "Red");
                        return false;
                    }
                    else {
                        $("#MsgFileupload").text("");
    ...
    <script type="text/javascript">
        function CheckWalletBalance() {
            $.ajax({
                url: "WalletRequest.aspx/Page_Load",
                data: {
                    method: "CheckBalance",
                ...
                success: function (msg) {
                    if (msg != '') {
                        ...
                        if (data[0].toString() == 'F') {
                            $('#MsgAmt').text('Wallet amount exceeded from the credit limit Rs. ' + data[1].toString()).css("color", "Red");
                            $('#txtAmount').val("");
                        }
                    }
                    else {
    ...
    <asp:ScriptManager ID="Mg" runat="server"></asp:ScriptManager>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="projectinput1">Amount(INR)<span class="starRed">*</span></label>
                                                    <asp:TextBox runat="server" ID="txtAmount" class="form-control" placeholder="Amount" MaxLength="8" onchange="CheckWalletBalance();"></asp:TextBox>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlPaymentMethod" runat="server" class="form-control select-user-drop-down">
                                            ...
                                            <div class="col-md-4 add-user-Workshop" id="Cheque">
                                                <div class="form-group">
                                                    <label for="projectinput2">Cheque No/NEFT Transaction No<span class="starRed">*</span></label>
                                                    <asp:TextBox ID="txtPayMethoDetails" runat="server" class="form-control " placeholder="Enter Details" MaxLength="20"></asp:TextBox>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtTranxDate" runat="server" class="form-control" placeholder="dd/mm/yyyy" AutoCompleteType="Disabled"></asp:TextBox>
                                                    <asp:CalendarExtender ID="CalendarExtender2" PopupButtonID="txtTranxDate" runat="server" TargetControlID="txtTranxDate" Format="dd/MM/yyyy"></asp:CalendarExtender>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 add-user-Workshop">
                                                <div class="form-group">
                                                    <h5>Upload Image:</h5>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="projectinput4">Comments (if any) <span class="starRed"></span></label>

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="BulkUpload.aspx.cs" Inherits="Admin_BulkUpload" ClientIDMode="Static" %>
                        ...
                        <div class="card">
                            <div class="card-body input-textbox">
                                <div class="table-responsive">
                                    ...
                                    <br />
                                    <div>
                                        <asp:Button ID="BtnUpload" runat="server" Text="Upload" class="btn btn-lg btn-primary Prospective-signup" OnClick="BtnUpload_Click" ClientIDMode="static" /><br />
                                    </div>
                                </div>
                            </div>
                        </div>
